...
public class Hash {
    ...
    Hash() {
        ...
        graphVerticies.put("4", "Класс: бедренная группа мышц.\nВы планируете делать упор на переднюю и внешнюю или заднюю и внутреннюю поверхность бедра?");
        ...
        graphVerticies.put("37", "Тип: упражнение - мертвая становая тяга\n(больший акцент на заднюю поверхность бедра, нежели чем на поясничный отдел)");
